...
public class AlarmTest extends AbstractModelTest {
  ...
  public AlarmTest() {
    ...
    alarm = new AlarmDetail("123", "90% CPU",
        "avg(hpcs.compute:cpu:1:{instance_id=666, image_id=345}) >= 90", AlarmState.OK, Arrays.asList(
            "123345345", "23423"));
  ...
  public void shouldDeserializeFromJson() throws Exception {
    ...
    assertEquals(alarm.getAlarmActions(), detail.getAlarmActions());
  }
}
